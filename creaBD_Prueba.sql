...
SELECT * FROM tai_pruebas.empleados E LEFT OUTER JOIN tai_pruebas.puestos P on E.id_puesto = P.id; 
...
SELECT * FROM tai_pruebas.empleados E RIGHT OUTER JOIN tai_pruebas.puestos P on E.id_puesto = P.id;
